...
│  │  • GitHub Models (FREE) OR Azure OpenAI (Pay-as-you-go)  │  │
...
- **Framework**: Next.js 14 (App Router dengan Server Components)
- **Language**: TypeScript (strict mode)
- **Styling**: Tailwind CSS v3
- **UI Components**: shadcn/ui (Radix UI primitives)
- **Code Editor**: Monaco Editor (VS Code engine)
- **Forms**: React Hook Form + Zod validation
- **HTTP Client**: Fetch API (native) / TanStack Query
...
- **Database ORM**: Prisma (via Prisma Client Python)
...
### 1. Frontend Development (Next.js 14)
...
│   └── charts/          # Learning analytics charts
├── lib/
│   ├── auth.ts          # Auth client (JWT-based)
